      ...
      <Card  style={{border: '2px solid white'}}>
        <Row>
          <Form onSubmit={feltoltes}>
            <img  className="photo" alt='Nincs kép' src={link} />
            <Form.Group>
            ...
            <Form.Group id="ep" size="md" controlId="meret">
              ...
              <Button variant="dark" size="md" onClick={meretHozzaadas}>Hozzáadás</Button>
            </Form.Group>
            ...
            <Button variant="dark" size="md" type="submit" >Feltöltés</Button>
